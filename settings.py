...
class Messages(object):
    ...
    ORIG_URL_LEN = (f'Длина ссылки от {Constants.ORIG_URL_MIN_LEN} и '
                    f'до {Constants.ORIG_URL_MAX_LEN} знаков')
    ORIG_URL_FORMAT = 'Ссылка должна быть в формате URL'
    SHORT_URL_NOT_UNIQUE = 'Предложенный вариант короткой ссылки уже существует.'
